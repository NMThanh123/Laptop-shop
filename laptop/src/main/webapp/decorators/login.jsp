...
#logreg-forms .form-signup .social-btn{ width:200px; }
        ...
        <form class="form-signin" action="login" method="post">
            ...
            <form action="signup" class="form-signup" method="post">
			    ...
			    <span class="input-group-text" onclick="password_show_hide_signup();">
			      <i class="fa fa-eye-slash" id="show_ey"></i>
			      <i class="fas fa-eye d-none" id="hide_ey"></i>
			    </span>
			  	</div>
			  	</div>
...
$(()=>{
    ...
    <script type="text/javascript">
        ...
        function password_show_hide_signup() {
  		  ...
  		  var show_ey = document.getElementById("show_ey");
  		  var hide_ey = document.getElementById("hide_ey");
  		  hide_ey.classList.remove("d-none");
  		  if (x.type === "password") {
  		    x.type = "text";
  		    show_ey.style.display = "none";
  		    hide_ey.style.display = "block";
  		  } else {
  		    x.type = "password";
  		    show_ey.style.display = "block";
  		    hide_ey.style.display = "none";
  		  }
  		}
    </script>
</body>
