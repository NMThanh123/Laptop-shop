...
<div style="text-align: center">
	<table  style="width: 50%" align="center">
		<thead>
		<th colspan="25" style="color:#3366cc;font-size:50px;letter-spacing: 1.5px; line-height: 1.5">Thương hiệu nổi bật
		<br>
		<br>
		</th>
		</thead>
		...
		<tbody>
			<c:forEach var="i" items="${list}">
				<th>
				<td>
					<a href="${i.name}" class="btn">
					<img src="${pageContext.request.contextPath}/image/provider_img/${i.icon}" border="0" alt="Logo" 
